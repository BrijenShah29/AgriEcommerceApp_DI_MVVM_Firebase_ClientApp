...
//
    ...
    private fun onPaymentSheetResult(paymentSheetResult: PaymentSheetResult) {
        ...
        when(paymentSheetResult) {
            ...
            is PaymentSheetResult.Completed -> {
                mProgressBar.visibility = View.INVISIBLE
                Snackbar.make(requireView(),"Your payment is successful. Please wait while we generate your Order !",Snackbar.LENGTH_SHORT).show()
                mProgressBar.visibility = View.VISIBLE
    ...
    private fun generateCustomerRecipt() {
        Log.d("Order receipt","Generate Order Recipt for new Order")
    }
    ...
    private fun generateCustomerOrder() {
        ...
        for(each in cartList)
        {
                ...
                val data = OrderedProductsModel(each.productId,each.productName,each.productQuantity.toString(),each.productSpecialPrice,each.productCoverImg)
                orderedProductsList.add(i,data)
...
//                orderedProductsList[i].orderedProductName = each.productName
        ...
        firestore.document(key).set(customerOrderData).addOnSuccessListener {
            Snackbar.make(requireView(),"Your Order Placed Successfully , Please Wait while we redirect you..",Snackbar.LENGTH_SHORT).show()
        ...
        // Empty the cart
            ...
            viewModelUsers.addOrdersIntoRoomDB(customerOrderData)
