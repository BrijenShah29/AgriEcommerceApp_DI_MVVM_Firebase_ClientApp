package com.example.mapd726_groupproject_team3_agriapp.Adapter.ProductsYouMayLikeAdapter
...
class ProductsYouMayLikeAdapter(val context: Context, val viewModel: ProductsViewModel) : androidx.recyclerview.widget.ListAdapter<YouMayLikeModel,ProductsYouMayLikeAdapter.YouMayLikeViewHolder>(YouMayLikeDiffUtil()) {
    var product: ProductModel? = null

    inner class YouMayLikeViewHolder(val binding: LayoutProductItemBinding) :
        RecyclerView.ViewHolder(binding.root) {

        fun bind(context: Context, item: YouMayLikeModel) {
            ...
            if (item.onSale == true) {
                ...
                ss.setSpan(
                    StrikethroughSpan(),
                    0,
                    binding.normalPrice.text.lastIndex,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YouMayLikeViewHolder {
        val binding = LayoutProductItemBinding.inflate(LayoutInflater.from(context), parent, false)
        return YouMayLikeViewHolder(binding)
    }

    override fun onBindViewHolder(holder: YouMayLikeViewHolder, position: Int) {
       ...
       private fun sendToNextScreen(view: View) {
            ...
            Handler(Looper.myLooper()!!).postDelayed(Runnable {
                ...
                if(product !=null) {
                    ...
                    val sender = (FragmentComponentManager.findActivity(view.context) as Activity as FragmentActivity).supportFragmentManager
        ...
        class YouMayLikeDiffUtil : DiffUtil.ItemCallback<YouMayLikeModel>() {
            override fun areItemsTheSame(
                oldItem: YouMayLikeModel,
                newItem: YouMayLikeModel
            ): Boolean {
